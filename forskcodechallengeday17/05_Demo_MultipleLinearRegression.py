...
Need more data: Only one year worth of data isn't that much, whereas having multile = labelencoder.transform(['Development'])ple years worth could have helped us le = labelencoder.transform(['Development'])improve the accuracy quite a bit.
